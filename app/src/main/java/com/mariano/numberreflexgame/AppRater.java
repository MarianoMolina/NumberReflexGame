...
public class AppRater {
    ...
    private static final String DEFAULT_TEXT_EXPLANATION = "Hey, you seem to have good reactions! We would be very happy if you could rate our application on Google Play. Thanks for your support!";
    ...
    private static final int DEFAULT_LAUNCHES_BEFORE_PROMPT = 4;
